...
public record AuthRegisterRequest(
        ...
        @Size(min = 2, max = 100, message = "El nombre debe tener entre 2 y 100 caracteres") // Corregido: max 100
        ...
        @Size(min = 2, max = 100, message = "El apellido materno no debe exceder los 100 caracteres")
        @Pattern(regexp = "^[a-zA-ZáéíóúÁÉÍÓÚñÑ\\s]+$",
